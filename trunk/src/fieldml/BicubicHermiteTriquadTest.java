    ...
    extends TestCase
{
    ...
    public static Region buildRegion()
    {
        ...
        BarEnsembleDomain testMeshElementDomain = new BarEnsembleDomain( "test_mesh.elements", 1, 2, 3 );
        ...
        EnsembleDomain globalNodesDomain = new FooEnsembleDomain( "test_mesh.nodes", 7 );
